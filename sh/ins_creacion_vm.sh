...
gcloud compute instances create instance-instalacion \
    ...
    --create-disk=auto-delete=yes,boot=yes,device-name=instance-instalacion,image=projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2504-plucky-amd64-v20250430,mode=rw,size=96,type=pd-balanced \
...
then
    ...
    gcloud storage buckets create gs://"$USER"_buko  --location=US
fi
