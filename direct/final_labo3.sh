...
printf "\n borrando imagen image-dm3 vieja si quedo como resabio de instalacion anterior\n\n"
gcloud compute images delete image-dm3  --quiet  --verbosity=none

gcloud compute images create image-dm3   \
       --source-disk=$MIHOST            \
...
gcloud compute instance-templates create temp-08vcpu-032ram         \
       ...
       --create-disk=auto-delete=yes,boot=yes,device-name=temp-08vcpu-032ram,image=image-dm3,mode=rw,size=256,type=pd-standard \
...
gcloud compute instance-templates create temp-08vcpu-064ram         \
       ...
       --scopes=cloud-platform                                      \
       --tags=http-server,https-server                              \
       --create-disk=auto-delete=yes,boot=yes,device-name=temp-08vcpu-064ram,image=image-dm3,mode=rw,size=256,type=pd-standard \
       --no-shielded-secure-boot --shielded-vtpm                    \
       --shielded-integrity-monitoring --reservation-affinity=any   \
       --metadata-from-file shutdown-script=/home/$USER/cloud-install/direct/shutdown-script.sh
...
gcloud compute instance-templates create temp-08vcpu-128ram         \
       ...
       --scopes=cloud-platform                                      \
       --tags=http-server,https-server                              \
       --create-disk=auto-delete=yes,boot=yes,device-name=temp-08vcpu-128ram,image=image-dm3,mode=rw,size=256,type=pd-standard \
       --no-shielded-secure-boot --shielded-vtpm                    \
       --shielded-integrity-monitoring --reservation-affinity=any   \
       --metadata-from-file shutdown-script=/home/$USER/cloud-install/direct/shutdown-script.sh
...
gcloud compute instance-templates create temp-08vcpu-256ram         \
       ...
       --scopes=cloud-platform                                      \
       --tags=http-server,https-server                              \
       --create-disk=auto-delete=yes,boot=yes,device-name=temp-08vcpu-256ram,image=image-dm3,mode=rw,size=256,type=pd-standard \
       --no-shielded-secure-boot --shielded-vtpm                    \
       --shielded-integrity-monitoring --reservation-affinity=any   \
       --metadata-from-file shutdown-script=/home/$USER/cloud-install/direct/shutdown-script.sh
...
gcloud compute instance-templates create temp-08vcpu-512ram         \
       ...
       --scopes=cloud-platform                                      \
       --tags=http-server,https-server                              \
       --create-disk=auto-delete=yes,boot=yes,device-name=temp-08vcpu-512ram,image=image-dm3,mode=rw,size=256,type=pd-standard \
       --no-shielded-secure-boot --shielded-vtpm                    \
       --shielded-integrity-monitoring --reservation-affinity=any   \
       --metadata-from-file shutdown-script=/home/$USER/cloud-install/direct/shutdown-script.sh
...
gcloud compute instances create desktop-jr \
    ...
    --tags=http-server,https-server \
    --create-disk=auto-delete=yes,boot=yes,device-name=desktop-jr,image=image-dm3,mode=rw,size=256,type=pd-standard \
...
gcloud compute instances create desktop-sr \
    ...
    --scopes=https://www.googleapis.com/auth/cloud-platform \
    --tags=http-server,https-server \
    --create-disk=auto-delete=yes,boot=yes,device-name=desktop-sr,image=image-dm3,mode=rw,size=256,type=pd-standard \
    --no-shielded-secure-boot  \
    --metadata-from-file shutdown-script=/home/$USER/cloud-install/direct/shutdown-script.sh
